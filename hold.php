...
<head>
  ...
  background: url(./img/bmw.jpg)no-repeat center center fixed;
  ...
  <div class="row justify-content-md-center mt-4">
    <div class="col-12">       
      ...
      ?>
        ...
        <div class="row">
            <div class="col-10 " class="postCategory">
              <p class="postCategory"><?=$postTitle;?></p>
            </div>
            <div class="col-2" class="text-right" class="text-monospace" class="ideaDate">
              <p><?=$postDate;?></p>
            </div>
            <div class="col-5 " class="postImage">
              <img class="card-img" src="img/porsche.jpg" alt="silhouette of head with gears">
            </div>
            <div class="col-5 " class="postImage">
              <img class="card-img" src="img/porsche.jpg" alt="silhouette of head with gears">
            </div>
            <!-- <img src="img/porsche.jpg" alt="silhouette of head with gears" class=" ml-2 text-center" height="300" > -->
            ...
            <div>
              <p class="blog-content m-2"><?=$postContent;?></p>
            </div>
